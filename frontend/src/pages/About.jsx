  ...
  return (
    <>
      <PageIntro
        ...
        text="بهارناژ یک استودیو زیبایی با تجربه‌ای ساده، شفاف و شخصی است؛ از دیدن خدمات تا انتخاب متخصص و رزرو زمان."
      ...
      <section className="about-page container">
        ...
        <div className="about-copy">
          <p>
            ...
            طوری طراحی شده که خدمات، متخصصان و زمان‌های واقعی را کنار هم ببینی و
